...
public class EditPreApprovalPO extends BasePO {
	...
	// This method is used for finding webElement of Edit Pre-approval
	@FindBy(xpath = "//span[normalize-space()='Edit Pre-approval']")
	private WebElement editPreApproval;

	// This method is used for finding webElement of Edit Claim
	@FindBy(xpath = "//div[contains(text(),'Edit Claim')]")
	private WebElement editClaimTitle;
	...
	// This method is used for finding webElement of claim not found
	@FindBy(xpath = "//div[contains(text(),'Claim not found')]")
	private WebElement claimNotFound;

	// This method is used for finding webElement of cannot find claim
	@FindBy(xpath = "//div[contains(text(),'Cannot find a claim for entered claim reference number')]")
	private WebElement cannotFindClaim;

	// This method is used for finding webElement of ok button
	@FindBy(xpath = "//div[contains(text(),'Search Claim')]")
	private WebElement searchClaimPopupText;

	// This method is used for finding webElement of search claim pop up
	@FindBy(xpath = "//button[contains(text(),'OK')]")
	private WebElement okButton;

	// This method is used for finding webElement of claim reference checkbox
	@FindBy(xpath = "//td[contains(@class,'claimRef')]/preceding-sibling::td/mat-checkbox")
	private WebElement claimReferenceCheckbox;

	// This method is used for finding webElement of view plan
	@FindBy(xpath = "//button[contains(@class,'view-btn')]/div")
	private WebElement viewPlanButton;

	// This method is used for finding webElement of new plan
	@FindBy(xpath = "//button[contains(@class,'new-btn')]/div")
	private WebElement newPlanButton;

	// This method is used for finding webElement of copy plan
	@FindBy(xpath = "//button[contains(@class,'copy-btn')]/div")
	private WebElement copyPlanButton;
	...
	@FindBy(xpath = "//div[contains(text(),'Appointment Booking')]")
	private WebElement appointmentBooking;

	@FindBy(xpath = "//div[@class='action-link-div ng-star-inserted']//div[@class='link-div']//img[@alt='No Icon']")
	...
	public void clickOnEditPreApprovals() throws InterruptedException {
		highLighterMethod(editPreApproval);
		editPreApproval.click();
		waitForVisibility(claimReference);
	}

	public WebElement getEditClaimTitle() {
		waitForVisibility(editClaimTitle);
		highLighterMethod(editClaimTitle);
		return editClaimTitle;
	}

	public void enterClaimReference(String claimReferenceValue) throws InterruptedException {
		highLighterMethod(claimReference);
		claimReference.clear();
		Thread.sleep(2000);
		claimReference.sendKeys(claimReferenceValue);
		claimReference.sendKeys(Keys.ENTER);
		Thread.sleep(3000);
	}

	public WebElement getClaimNotFoundText() {
		waitForVisibility(claimNotFound);
		highLighterMethod(claimNotFound);
		return claimNotFound;
	}

	public WebElement getCannotFindClaimText() {
		highLighterMethod(cannotFindClaim);
		return cannotFindClaim;
	}

	public void clickOnOkbutton() throws InterruptedException {
		highLighterMethod(okButton);
		okButton.click();
		Thread.sleep(3000);
	}

	public WebElement getSearchClaimPopupText() {
		waitForVisibility(searchClaimPopupText);
		highLighterMethod(searchClaimPopupText);
		return searchClaimPopupText;
	}

	public void selectViewPlanOrNewPlanOrCopyPlan(String planOption) throws InterruptedException {
		waitForVisibility(claimReferenceCheckbox);
		highLighterMethod(claimReferenceCheckbox);
		claimReferenceCheckbox.click();
		Thread.sleep(3000);
		if (viewPlanButton.getText().trim().equals(planOption)) {
			viewPlanButton.click();
		} else if (newPlanButton.getText().trim().equals(planOption)) {
			newPlanButton.click();
		} else if (copyPlanButton.getText().trim().equals(planOption)) {
	...
	public WebElement getAppointmentBooking() {
		highLighterMethod(appointmentBooking);
		return appointmentBooking;
	}

	public WebElement getPlusIcon() {
		highLighterMethod(plusIcon);
		return plusIcon;
	}
